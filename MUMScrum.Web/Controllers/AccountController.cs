...
namespace MUMScrum.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = hrService.Login(model.UserName, model.Password);
            if (result != null)
            {
                Utility.CreateEmployeeSession(this.HttpContext.Session, result);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        [MUMScrum.Web.Authorization.ScrumAuthorization]
